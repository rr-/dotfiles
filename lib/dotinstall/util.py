...
def concat_files(sources, target, comment_fmt=None):
    ...
    with open(target, 'w') as target_handle:
        if comment_fmt:
            print(comment_fmt % 'DO NOT EDIT THIS FILE',
                  file=target_handle)
            print(comment_fmt % 'This file was concatenated by dotfiles utility.',
                  file=target_handle)
            print(comment_fmt % 'All changes in this file will not be retained.',
                  file=target_handle)
            print(file=target_handle)
        for source in sources:
            if comment_fmt:
                print(comment_fmt % 'Concatenated file %s of %s from: %s'
