...
config.set("content.javascript.enabled", True, "*://*.slack.com/*")
config.set("content.javascript.enabled", True, "*://yume.pl/*")
config.set("content.javascript.enabled", True, "*://oldcastle.moe/*")
config.set("content.javascript.enabled", True, "*://*.stxnext.pl/*")
config.set("content.javascript.enabled", True, "*://*.youtube.com/*")
config.set("content.javascript.enabled", True, "*://*.twitch.tv/*")
config.set("content.javascript.enabled", True, "*://*.atlassian.net/*")
...
config.set("content.javascript.enabled", True, "*://maps.google.com/*")
